...
az_rg_name      = "hub-rg-canadacentral"
az_rg_location  = "canadacentral"
az_tags = {
ApplicationName = "Network"
Role 		    = "Network"
Owner 		    = "wembley@gormleytech.com"
Environment	    = "Prod"
CompanyName     = "RSG"
Criticality     = "Medium"
DR 		        = "No"
...
source = "./modules/resourcegroups"
# Resource Group Variables
az_rg_name     = "spoke1-rg-canadacentral"
az_rg_location = "canadacentral"
az_tags = {
ApplicationName = "Network"
Role 		    = "Network"
...
source = "./modules/resourcegroups"
# Resource Group Variables
az_rg_name     = "mgmt-rg-canadacentral"
az_rg_location = "canadacentral"
az_tags = {
ApplicationName = "Network"
Role 		    = "Network"
...
source = "./modules/resourcegroups"
# Resource Group Variables
az_rg_name     = "mgmt01-rg-canadacentral"
az_rg_location = "canadacentral"
az_tags = {
ApplicationName = "Network"
Role 		    = "Network"
...
virtual_network_peering_name = "hub_vnet_to_spoke1_vnet"
resource_group_name          = module.hub-resourcegroup.rg_name
...
virtual_network_peering_name = "spoke1_vnet_to_hub_vnet"
resource_group_name          = module.spoke1-resourcegroup.rg_name
...
public_ip_name      = "app_GW_public_ip"
resource_group_name = module.hub-resourcegroup.rg_name
location            = module.hub-resourcegroup.rg_location
allocation_method   = "Static"
sku                 = "Standard"
...
public_ip_name      = "azure_firewall_public_ip"
resource_group_name = module.hub-resourcegroup.rg_name
location            = module.hub-resourcegroup.rg_location
allocation_method   = "Static"
sku                 = "Standard"
...
depends_on = [module.hub-vnet]
  ...
  azure_firewall_name = "hub_firewall"
  location            = module.hub-resourcegroup.rg_location
  resource_group_name = module.hub-resourcegroup.rg_name
  sku_name            = "AZFW_VNet"
  sku_tier            = "Standard"
  ...
  azure_firewall_policy_coll_group_name  = "hub_firewall_coll_pol01" 
  azure_firewall_policy_name             = "hub_firewall_pol01"  
  priority                               = 100
...
recovery_vault_name = "hub_mgmt_backup"
...
virtual_machine_name             = "azRSGrap01"
nic_name                         = "azRSGrap01-nic"
location                         = module.spoke1-resourcegroup.rg_location
resource_group_name              = module.spoke1-resourcegroup.rg_name
...
os_disk_name                     = "azRSGrap01osdisk"
caching                          = "ReadWrite"
create_option                    = "FromImage"
managed_disk_type                = "Premium_LRS"

admin_username                   = "RSG.admin"
...
virtual_machine_name             = "azRSGrdb01"
vm_size                          = "Standard_D2s_v3"
...
source = "./modules/vm-windows"
virtual_machine_name             = "azRSGrjump01"
nic_name                         = "azRSGrjump01-nic"
...
os_disk_name                     = "azRSGrjump01osdisk"
caching                          = "ReadWrite"
create_option                    = "FromImage"
managed_disk_type                = "Premium_LRS"
...
bastion_host_name              = "bastion_vm.local"
resource_group_name            = module.hub-resourcegroup.rg_name
location                       = module.hub-resourcegroup.rg_location
...
key_vault_name = "rsg_azure_key_vault"
sku_name = "standard"
